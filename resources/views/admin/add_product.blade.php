                ...
                <div class=logisco-mobile-menu><a class="logisco-mm-menu-button logisco-mobile-menu-button logisco-mobile-button-hamburger" href=#logisco-mobile-menu><span></span></a>
                    <div class="logisco-mm-menu-wrap logisco-navigation-font" id=logisco-mobile-menu data-slide=right>
                        <ul id=menu-main-navigation class=m-menu>
                            ...
                            <li class="menu-item menu-item-has-children current-menu-item"><a href={{url('/mylocation')}}>My Location</a> </li>
                            <li class="menu-item menu-item-has-children current-menu-item"><a href={{url('/mylocation')}}>My Product</a>  </li>
...
<div class="logisco-body-outer-wrapper ">
    <div class="logisco-body-wrapper clearfix  logisco-with-transparent-header logisco-with-frame">
                        ...
                        <div class="logisco-navigation logisco-item-pdlr clearfix ">
                            <div class=logisco-main-menu id=logisco-main-menu>
                                <ul id=menu-main-navigation-1 class=sf-menu>
                                    ...
                                    <li class="menu-item menu-item-has-children  current-menu-item logisco-normal-menu"><a href={{url('/view_product')}}>My Product</a>
        ...
        <!--<div class=logisco-page-wrapper id=logisco-page-wrapper>
		 ...
		 <div class="logisco-page-title-wrap  logisco-style-large logisco-center-align" style="background-image: url(assect/upload/loc_bg.png) ;background-size: cover ;background-position: center ;">
            ...
            <div class="logisco-page-title-container logisco-container">
                <div class="logisco-page-title-content logisco-item-pdlr">
                    <h3 class="logisco-page-title">Add Product</h3>
                        ...
                        <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                            <div class="gdlr-core-pbf-column gdlr-core-column-60 gdlr-core-column-first">
                                <div class="gdlr-core-pbf-column-content-margin gdlr-core-js ">
                                    <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js " style=" max-width: 800px; padding: 40px;">
                                        <div class="gdlr-core-pbf-element">
                                            <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-center-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr" style="padding-bottom: 45px ;">
                                                <div class="gdlr-core-title-item-title-wrap ">
                                                    <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 39px ;letter-spacing: 0px ;text-transform: none ;">Add  Product <span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider"></span></h3></div><span class="gdlr-core-title-item-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 19px ;font-style: normal ;"></span></div>
                                        </div>
                                        <div id="msg"></div>
                                                        ...
                                                        <div class="quform-elements">
                                                            <div class="quform-element">
                                                                ...
                                                                <span class="wpcf7-form-control-wrap your-name">
                                                                    <input id="pname" type="text" name="pname" required size="40" class="input1" aria-required="true" aria-invalid="false" placeholder="Product Name">
                                                                </span> 
                                                            ...
                                                            <div class="quform-element">
                                                                ...
                                                                <span class="wpcf7-form-control-wrap your-email">
                                                                    <input id="url" type="text" name="url" size="40" required class="input1" aria-required="true" aria-invalid="false" placeholder="Own website">
                                                                </span> 
                                                            
                                                            </div>
                                                            <div><input class="form-control"  name="accesstoken" required type="hidden" value="123hg213g123hg231hg321h123fgj" ></div>
                                                             <div><input class="form-control" id="dealerID" name="dealerid" required type="hidden" value="{{ Session::get('admin') }}"> </div>
                                                            <div class="quform-element">
                                                           
                                                               <span class="wpcf7-form-control-wrap your-email">
                                                                    <input id="product_img" type="file" name="product_img" size="40" class="input1" required aria-required="true" aria-invalid="false" placeholder="Location image">
                                                                </span> 
                                                            ...
                                                            <div class="quform-submit quform-submit-inner2">
                                                                <div class="quform-submit-inner">
                                                                    <button type="submit" class="submit-button"><span>Save</span></button>
                                                                </div>
...
$("form#data").submit(function(e) {
 ...
 //action="http://phpstack-102119-1169738.cloudwaysapps.com/API/dealer.php/mylocation" 
    $.ajax({
        url: "{{ Session::get('url') }}API/dealer.php/add_product",
        type: 'POST',
        data: formData,
