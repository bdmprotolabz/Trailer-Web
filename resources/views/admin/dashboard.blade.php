...
<head>
  ...
  <meta name="author" content="Protolabz">
  <title>People-Admin-panel</title>
  <link rel="apple-touch-icon" href="../../../ad_assects/app-assets/images/logo/icon-n.png">
  <link rel="shortcut icon" type="image/x-icon" href="../../../ad_assects/app-assets/images/logo/icon-n.png">
  <link href="https://fonts.googleapis.com/css?family=Montserrat:300,300i,400,400i,500,500i%7COpen+Sans:300,300i,400,400i,600,600i,700,700i"
  rel="stylesheet">
  <!-- BEGIN VENDOR CSS-->
  <link rel="stylesheet" type="text/css" href="../../../ad_assects/app-assets/css/vendors.css">
  <link rel="stylesheet" type="text/css" href="../../../ad_assects/app-assets/vendors/css/forms/icheck/icheck.css">
  <link rel="stylesheet" type="text/css" href="../../../ad_assects/app-assets/vendors/css/forms/icheck/custom.css">
  <link rel="stylesheet" type="text/css" href="../../../ad_assects/app-assets/vendors/css/charts/morris.css">
  <link rel="stylesheet" type="text/css" href="../../../ad_assects/app-assets/vendors/css/extensions/unslider.css">
  <link rel="stylesheet" type="text/css" href="../../../ad_assects/app-assets/vendors/css/weather-icons/climacons.min.css">
  <!-- END VENDOR CSS-->
  <!-- BEGIN STACK CSS-->
  <link rel="stylesheet" type="text/css" href="../../../ad_assects/app-assets/css/app.css">
  <!-- END STACK CSS-->
  <!-- BEGIN Page Level CSS-->
  <link rel="stylesheet" type="text/css" href="../../../ad_assects/app-assets/css/core/menu/menu-types/vertical-menu.css">
  <link rel="stylesheet" type="text/css" href="../../../ad_assects/app-assets/css/core/colors/palette-climacon.css">
  <link rel="stylesheet" type="text/css" href="../../../ad_assects/app-assets/css/core/colors/palette-gradient.css">
  <link rel="stylesheet" type="text/css" href="../../../ad_assects/app-assets/fonts/simple-line-icons/style.min.css">
  <link rel="stylesheet" type="text/css" href="../../../ad_assects/app-assets/fonts/meteocons/style.min.css">
  <link rel="stylesheet" type="text/css" href="../../../ad_assects/app-assets/css/pages/users.css">
  <!-- END Page Level CSS-->
  <!-- BEGIN Custom CSS-->
  <link rel="stylesheet" type="text/css" href="../../../ad_assects/assets/css/style.css">
  <!-- END Custom CSS-->
        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="">
              <img class="brand-logo" alt="stack admin logo" src="admin/assets/images/logo-icon1.png" >
             <h2 class="brand-text" style="color:#3598db;">The Trailer</h2>
            </a>
          </li>
            ...
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                <span class="avatar avatar-online">
                  <img src="<?php if($result1->image==''){ echo 'http://phpstack-102119-1169738.cloudwaysapps.com/img/location/demy.jpg';}else{
                  echo $result1->image; ?>" alt="avatar"><i></i></span>
                <span class="user-name">{{$result1->name}}
</span>
              </a>
      ...
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item"><a href="index.html"><i class="ft-home"></i><span class="menu-title" data-i18n="">Dashboard</span><span class="badge badge badge-primary badge-pill float-right mr-2">3</span></a>
          <ul class="menu-content">
            ...
            <li class="active"><a class="menu-item" href="dashboard-fitness.html">Fitness</a>
            </li>
          </ul>
        </li>
        ...
        <li class=" nav-item"><a href="#"><i class="ft-zap"></i><span class="menu-title" data-i18n="">Starter kit</span><span class="badge badge badge-danger badge-pill float-right mr-2">New</span></a>
          <ul class="menu-content">
            <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-menu-template-light/layout-1-column.html">1 column</a>
            </li>
            <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-menu-template-light/layout-2-columns.html">2 columns</a>
            </li>
            <li><a class="menu-item" href="#">Content Det. Sidebar</a>
              <ul class="menu-content">
                <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-menu-template-light/layout-content-detached-left-sidebar.html">Detached left sidebar</a>
                </li>
                <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-menu-template-light/layout-content-detached-left-sticky-sidebar.html">Detached sticky left sidebar</a>
                </li>
                <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-menu-template-light/layout-content-detached-right-sidebar.html">Detached right sidebar</a>
                </li>
                <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-menu-template-light/layout-content-detached-right-sticky-sidebar.html">Detached sticky right sidebar</a>
                </li>
              </ul>
            </li>
            <li class="navigation-divider"></li>
            <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-menu-template-light/layout-fixed-navbar.html">Fixed navbar</a>
            </li>
            <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-menu-template-light/layout-fixed-navigation.html">Fixed navigation</a>
            </li>
            <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-menu-template-light/layout-fixed-navbar-navigation.html">Fixed navbar &amp; navigation</a>
            </li>
            <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-menu-template-light/layout-fixed-navbar-footer.html">Fixed navbar &amp; footer</a>
            </li>
            <li class="navigation-divider"></li>
            <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-menu-template-light/layout-fixed.html">Fixed layout</a>
            </li>
            <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-menu-template-light/layout-boxed.html">Boxed layout</a>
            </li>
            <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-menu-template-light/layout-static.html">Static layout</a>
            </li>
            <li class="navigation-divider"></li>
            <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-menu-template-light/layout-light.html">Light layout</a>
            </li>
            <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-menu-template-light/layout-dark.html">Dark layout</a>
            </li>
            <li><a class="menu-item" href="../../../starter-kit/ltr/vertical-menu-template-light/layout-semi-dark.html">Semi dark layout</a>
            </li>
          </ul>
        </li>
        <li class=" navigation-header">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-12 border-right-blue-grey border-right-lighten-5 clearfix">
                      <div class="media">
                        <div class="media-left pr-1">
                          <img class="media-object img-xl" src="../../../ad_assects/app-assets/images/portrait/small/avatar-s-5.png"
              ...
              <div class="card-content">
                ...
                <ul class="list-group list-group-flush">
                  <li class="list-group-item">
                    <span class="badge badge-default badge-pill bg-primary float-right">4</span> Protein Milk
                  </li>
                  <li class="list-group-item">
                    <span class="badge badge-default badge-pill bg-info float-right">2</span> oz Water
                  </li>
                  <li class="list-group-item">
                    <span class="badge badge-default badge-pill bg-danger float-right">8</span> Vegetable Juice
                  </li>
                  <li class="list-group-item">
                    <span class="badge badge-default badge-pill bg-warning float-right">1</span> Sugar Free Jello-O
                  </li>
                  <li class="list-group-item">
                    <span class="badge badge-default badge-pill bg-success float-right">3</span> Protein Meal
                  </li>
                </ul>
                <div class="card-body">
              ...
              <div class="card-content">
                ...
                <div class="card-body bg-success bg-lighten-4">
                  ...
                  <div class="animated-weather-icons text-center">
                    <svg version="1.1" id="wind1" class="climacon climacon_wind climacon-success climacon-darken-2 height-200"
                    viewBox="15 15 70 70">
                ...
                <div class="card-footer bg-success bg-darken-3 py-3 text-center border-0">
                  <div class="row">
                    ...
                    <div class="col-4 text-center display-table-cell">
                      ...
                      <span class="white align-middle">13.0&deg;</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card-content">
                <div id="friends-activity" class="media-list height-400 position-relative">
                  <a href="#" class="media border-0">
                    <div class="media-left pr-1">
                      <img class="media-object avatar avatar-sm rounded-circle" src="../../../ad_assects/app-assets/images/portrait/small/avatar-s-7.png"
                      alt="Generic placeholder image">
                    </div>
                    <div class="media-body w-100">
                      <h5 class="list-group-item-heading">Kristopher Candy
                        <span class="font-medium-4 float-right">1,0215</span>
                      </h5>
                      <p class="list-group-item-text mb-0">
                        <span class="badge badge-success">Running</span>
                        <span class="badge badge-warning ml-1">Cycling</span>
                      </p>
                    </div>
                  </a>
                  <a href="#" class="media border-0">
                    <div class="media-left pr-1">
                      <img class="media-object avatar avatar-sm rounded-circle" src="../../../ad_assects/app-assets/images/portrait/small/avatar-s-8.png"
                      alt="Generic placeholder image">
                    </div>
                    <div class="media-body w-100">
                      <h5 class="list-group-item-heading">Lawrence Fowler
                        <span class="font-medium-4 float-right">2,0215</span>
                      </h5>
                      <p class="list-group-item-text mb-0">
                        <span class="badge badge-danger">Dancing</span>
                        <span class="badge badge-primary ml-1">Fitness</span>
                      </p>
                    </div>
                  </a>
                  <a href="#" class="media border-0">
                    <div class="media-left pr-1">
                      <img class="media-object avatar avatar-sm rounded-circle" src="../../../ad_assects/app-assets/images/portrait/small/avatar-s-9.png"
                      alt="Generic placeholder image">
                    </div>
                    <div class="media-body w-100">
                      <h5 class="list-group-item-heading">Linda Olson
                        <span class="font-medium-4 float-right">1,112</span>
                      </h5>
                      <p class="list-group-item-text mb-0">
                        <span class="badge badge-success">Running</span>
                        <span class="badge badge-warning ml-1">Cycling</span>
                        <span class="tag bg-grey ml-1">Other</span>
                      </p>
                    </div>
                  </a>
                  <a href="#" class="media border-0">
                    <div class="media-left pr-1">
                      <img class="media-object avatar avatar-sm rounded-circle" src="../../../app-assets/images/portrait/small/avatar-s-10.png"
                      alt="Generic placeholder image">
                    </div>
                    <div class="media-body w-100">
                      <h5 class="list-group-item-heading">Roy Clark
                        <span class="font-medium-4 float-right">2,815</span>
                      </h5>
                      <p class="list-group-item-text mb-0">
                        <span class="badge badge-warning">Fitness</span>
                        <span class="badge badge-danger ml-1">Dancing</span>
                      </p>
                    </div>
                  </a>
                  <a href="#" class="media border-0">
                    <div class="media-left pr-1">
                      <img class="media-object avatar avatar-sm rounded-circle" src="../../../app-assets/images/portrait/small/avatar-s-11.png"
                      alt="Generic placeholder image">
                    </div>
                    <div class="media-body w-100">
                      <h5 class="list-group-item-heading">Tammy Gonzales
                        <span class="font-medium-4 float-right">3,226</span>
                      </h5>
                      <p class="list-group-item-text mb-0">
                        <span class="badge badge-danger">Dancing</span>
                        <span class="badge badge-success ml-1">Running</span>
                      </p>
                    </div>
                  </a>
                  <a href="#" class="media border-0">
                    <div class="media-left pr-1">
                      <img class="media-object avatar avatar-sm rounded-circle" src="../../../app-assets/images/portrait/small/avatar-s-12.png"
                      alt="Generic placeholder image">
                    </div>
                    <div class="media-body w-100">
                      <h5 class="list-group-item-heading">Justin Hawkins
                        <span class="font-medium-4 float-right">4,564</span>
                      </h5>
                      <p class="list-group-item-text mb-0">
                        <span class="badge badge-success">Running</span>
                        <span class="badge badge-primary ml-1">Fitness</span>
...
<!-- ////////////////////////////////////////////////////////////////////////////-->
  <footer class="footer footer-static footer-light navbar-border">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <span class="float-md-left d-block d-md-inline-block">Copyright &copy; 2018 <a class="text-bold-800 grey darken-2" href=""
        target="_blank">The People </a>, All rights reserved. </span>
  ...
  <!-- BEGIN VENDOR JS-->
  <script src="../../../ad_assects/app-assets/vendors/js/vendors.min.js" type="text/javascript"></script>
  <!-- BEGIN VENDOR JS-->
  <!-- BEGIN PAGE VENDOR JS-->
  <script src="//maps.googleapis.com/maps/api/js?key=AIzaSyBDkKetQwosod2SZ7ZGCpxuJdxY3kxo5Po"
  type="text/javascript"></script>
  <script src="../../../ad_assects/app-assets/vendors/js/charts/gmaps.min.js" type="text/javascript"></script>
  <script src="../../../ad_assects/app-assets/vendors/js/forms/icheck/icheck.min.js" type="text/javascript"></script>
  <script src="../../../ad_assects/app-assets/vendors/js/extensions/jquery.knob.min.js" type="text/javascript"></script>
  <script src="../../../ad_assects/app-assets/vendors/js/charts/raphael-min.js" type="text/javascript"></script>
  <script src="../../../ad_assects/app-assets/vendors/js/charts/morris.min.js" type="text/javascript"></script>
  <script src="../../../ad_assects/app-assets/vendors/js/charts/jquery.sparkline.min.js" type="text/javascript"></script>
  <script src="../../../ad_assects/app-assets/vendors/js/extensions/unslider-min.js" type="text/javascript"></script>
  <script src="../../../ad_assects/app-assets/vendors/js/charts/echarts/echarts.js" type="text/javascript"></script>
  <!-- END PAGE VENDOR JS-->
  <!-- BEGIN STACK JS-->
  <script src="../../../ad_assects/app-assets/js/core/app-menu.js" type="text/javascript"></script>
  <script src="../../../ad_assects/app-assets/js/core/app.js" type="text/javascript"></script>
  <script src="../../../ad_assects/app-assets/js/scripts/customizer.js" type="text/javascript"></script>
  <!-- END STACK JS-->
  <!-- BEGIN PAGE LEVEL JS-->
  <script src="../../../ad_assects/app-assets/js/scripts/pages/dashboard-fitness.js" type="text/javascript"></script>
  <!-- END PAGE LEVEL JS-->
